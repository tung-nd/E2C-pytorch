...
def sample_pendulum(sample_size, output_dir='data/pendulum_markov', step_size=1, apply_control=True, num_shards=10):
    ...
    for i in trange(sample_size):
        ...
        initial_state = state
        before = env.render_state(state[0])
        ...
        after_state = state
        after = env.render_state(state[0])
